...
public class MenuActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.item_about)
        {
            ...
            builder.setMessage("F1 Leaderboard is an app made for comparing achievements done between in the F1 Online Game. " +
                    "In this app, the users are able to create a league with their friends, and compare their scores. So, go on, " +
                    "enjoy racing with your friends, and don't forget to update your records in the app!");
        ...
        if (item.getItemId() == R.id.item_developer)
        {
            ...
            builder.setMessage("Hi, my name is ido Segev and I'm the developer of this app. I am a 12th grade student, " +
                    "and I live in Rakefet, a small community settlement in the north of Israel. " +
                    "I have made this app as part of my project in Computer Science class. If you enjoyed the app, please let me know by pressing " +
                    "the 'Rate This App' button on the menu, thanks!");
            builder.setPositiveButton("Close", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
